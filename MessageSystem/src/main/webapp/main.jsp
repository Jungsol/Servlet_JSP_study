		...
		<nav id="menu">
			<ul class="links">
				...
				<form action="" method="post">
					...
					<li><input type="submit" value="Log In" class="button fit"></li>
				</form>
				<li>
					<h5>회원가입</h5>
				</li>
				<form action="JoinCon" method="get">
					<li><input type="text" name="email" id="input_id" placeholder="Email을 입력하세요"></li>
